...
import me.qtill.commons.base.SystemPropertiesUtil;
import me.qtill.commons.collection.MapUtil;
...
public class NetUtil {
    ...
    private static class LocalAddress {
        ...
        public LocalAddress() {
            ...
            hostName = PlatformUtils.IS_WINDOWS ? System.getenv("COMPUTERNAME") : System.getenv("HOSTNAME");
        }
     ...
     *
     * TODO: 这个算法的效率是否够高？不能应用于高并发的场景下，但本身高并发建立serverSocket这样的场景就不常见
