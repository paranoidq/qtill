...
import me.qtill.commons.concurrent.jsr166e.LongAdder;
...
public class Concurrents {
    ...
    /**
     * 返回带warmup的令牌桶算法的RateLimiter
     *
     * @param permitPerSecond
     * @param warmupPeriod
     * @param unit
     * @return
     */
    public static RateLimiter rateLimiter(int permitPerSecond, long warmupPeriod, TimeUnit unit) {
        return RateLimiter.create(permitPerSecond, warmupPeriod, unit);
    }
