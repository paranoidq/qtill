...
/**
 * 1. 从string（true/false、yest/no）转换为Boolean
 *
...
public class BooleanUtil {
    ...
    /**
     * 使用标准JDK，只分析忽略大小写的"true", str为空时返回false
     */
    ...
    /**
     * 使用标准JDK，只分析忽略大小写的"true", str为空时返回defaultValue
     */
    ...
    /**
     * 使用标准JDK，只分析忽略大小写的"true", str为空时返回f
     */
