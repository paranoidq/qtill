 ...
 *
 * 4. StackTrace性能优化相关，尽量使用静态异常避免异常生成时获取StackTrace(Netty) @see org.springside.modules.utils.base.type.CloneableException
 *
 * @author paranoidq
 * @since 1.0.0
 */
public class ExceptionUtil {
     ...
     *
     * 对某些已知且经常抛出的异常, 不需要每次创建异常类并很消耗性能的生成完整的StackTrace. 此时可使用静态声明的异常.
     *
